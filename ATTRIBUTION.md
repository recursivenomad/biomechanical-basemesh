...
Generic human reference model is the default Collada (.dae) export from [MakeHuman 1.2.0][URL-MakeHuman-1.2.0], provided from MakeHuman [under the *CC0 1.0 Universal*][URL-MakeHuman-CC0] public domain dedication.
...
- [Blender][URL-Blender] - 3D modelling
